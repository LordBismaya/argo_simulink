...
static const char * c3_debug_family_names[65] = { "M", "Ms", "Izz", "Ixx", "Ixz",
...
static void initialize_c3_SS6_Estimation2(SFc3_SS6_Estimation2InstanceStruct
  *chartInstance);
static void initialize_params_c3_SS6_Estimation2
  (SFc3_SS6_Estimation2InstanceStruct *chartInstance);
static void enable_c3_SS6_Estimation2(SFc3_SS6_Estimation2InstanceStruct
  *chartInstance);
static void disable_c3_SS6_Estimation2(SFc3_SS6_Estimation2InstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_SS6_Estimation2
  (SFc3_SS6_Estimation2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_SS6_Estimation2
  (SFc3_SS6_Estimation2InstanceStruct *chartInstance);
static void set_sim_state_c3_SS6_Estimation2(SFc3_SS6_Estimation2InstanceStruct *
  chartInstance, const mxArray *c3_st);
static void finalize_c3_SS6_Estimation2(SFc3_SS6_Estimation2InstanceStruct
  *chartInstance);
static void sf_gateway_c3_SS6_Estimation2(SFc3_SS6_Estimation2InstanceStruct
  *chartInstance);
static void mdl_start_c3_SS6_Estimation2(SFc3_SS6_Estimation2InstanceStruct
  *chartInstance);
static void c3_chartstep_c3_SS6_Estimation2(SFc3_SS6_Estimation2InstanceStruct
  *chartInstance);
static void initSimStructsc3_SS6_Estimation2(SFc3_SS6_Estimation2InstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c3_b_F_SR_m, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[6]);
...
static real_T c3_sqrt(SFc3_SS6_Estimation2InstanceStruct *chartInstance, real_T
                      c3_x);
static void c3_eml_error(SFc3_SS6_Estimation2InstanceStruct *chartInstance);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_SS6_Estimation2, const char_T
  *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sqrt(SFc3_SS6_Estimation2InstanceStruct *chartInstance, real_T *
                      c3_x);
static void init_dsm_address_info(SFc3_SS6_Estimation2InstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc3_SS6_Estimation2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_SS6_Estimation2 = 0U;
}
  ...
  (SFc3_SS6_Estimation2InstanceStruct *chartInstance)
{
  ...
  c3_i_hoistedGlobal = chartInstance->c3_is_active_c3_SS6_Estimation2;
  ...
  chartInstance, const mxArray *c3_st)
{
  ...
  *chartInstance->c3_a_rR = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c3_is_active_c3_SS6_Estimation2 = c3_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 8)),
     "is_active_c3_SS6_Estimation2");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_SS6_Estimation2(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_SS6_Estimation2(chartInstance);
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_r, 6U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_a_fR, 7U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_a_rR, 8U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_a_mR, 9U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_F_SR_f, 10U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_F_SR_r, 11U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_F_SR_m, 12U);
}
  ...
  *chartInstance)
{
  ...
  real_T c3_b_Slip;
  real_T c3_b_r;
  uint32_T c3_debug_family_var_map[65];
  real_T c3_M;
  real_T c3_Ms;
  real_T c3_Izz;
  real_T c3_Ixx;
  ...
  c3_e_hoistedGlobal = *chartInstance->c3_r;
  c3_b_FzR = c3_hoistedGlobal;
  c3_b_U = c3_b_hoistedGlobal;
  c3_b_V = c3_c_hoistedGlobal;
  c3_b_Slip = c3_d_hoistedGlobal;
  c3_b_r = c3_e_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 65U, 65U, c3_debug_family_names,
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_b_r, 56U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_F_SR, 57U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_F_tR, 58U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_a_fR, 59U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_a_rR, 60U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_a_mR, 61U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_F_SR_f, 62U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_F_SR_r, 63U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_F_SR_m, 64U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c3_j_x = c3_b_a_rR;
  c3_b_a_rR = c3_j_x;
  c3_b_a_rR = muDoubleScalarAtan(c3_b_a_rR);
  ...
  c3_o_x = c3_b_a_mR;
  c3_b_a_mR = c3_o_x;
  c3_b_a_mR = muDoubleScalarAtan(c3_b_a_mR);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_SS6_Estimation2InstanceStruct *chartInstance;
  chartInstance = (SFc3_SS6_Estimation2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_SS6_Estimation2_get_eml_resolved_functions_info(void)
{
  ...
  *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_SS6_Estimation2), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_SS6_Estimation2);
  return c3_y;
}
...
void sf_c3_SS6_Estimation2_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c3_SS6_Estimation2_get_post_codegen_info(void);
mxArray *sf_c3_SS6_Estimation2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c3_SS6_Estimation2_get_post_codegen_info();
...
mxArray *sf_c3_SS6_Estimation2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_SS6_Estimation2_jit_fallback_info(void)
{
...
mxArray *sf_c3_SS6_Estimation2_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_SS6_Estimation2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x9'type','srcId','name','auxInfo'{{M[1],M[5],T\"F_SR\",},{M[1],M[25],T\"F_SR_f\",},{M[1],M[27],T\"F_SR_m\",},{M[1],M[26],T\"F_SR_r\",},{M[1],M[15],T\"F_tR\",},{M[1],M[18],T\"a_fR\",},{M[1],M[21],T\"a_mR\",},{M[1],M[19],T\"a_rR\",},{M[8],M[0],T\"is_active_c3_SS6_Estimation2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 9, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_SS6_Estimation2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_SS6_Estimation2InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c3_r);
        _SFD_SET_DATA_VALUE_PTR(7U, chartInstance->c3_a_fR);
        _SFD_SET_DATA_VALUE_PTR(8U, chartInstance->c3_a_rR);
        _SFD_SET_DATA_VALUE_PTR(9U, chartInstance->c3_a_mR);
        _SFD_SET_DATA_VALUE_PTR(10U, chartInstance->c3_F_SR_f);
        _SFD_SET_DATA_VALUE_PTR(11U, chartInstance->c3_F_SR_r);
        _SFD_SET_DATA_VALUE_PTR(12U, chartInstance->c3_F_SR_m);
      }
    } else {
...
static void sf_opaque_initialize_c3_SS6_Estimation2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_SS6_Estimation2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_SS6_Estimation2((SFc3_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
  initialize_c3_SS6_Estimation2((SFc3_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_SS6_Estimation2(void *chartInstanceVar)
{
  enable_c3_SS6_Estimation2((SFc3_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_SS6_Estimation2(void *chartInstanceVar)
{
  disable_c3_SS6_Estimation2((SFc3_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_SS6_Estimation2(void *chartInstanceVar)
{
  sf_gateway_c3_SS6_Estimation2((SFc3_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c3_SS6_Estimation2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_SS6_Estimation2((SFc3_SS6_Estimation2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_SS6_Estimation2(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c3_SS6_Estimation2((SFc3_SS6_Estimation2InstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c3_SS6_Estimation2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_SS6_Estimation2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_SS6_Estimation2((SFc3_SS6_Estimation2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_SS6_Estimation2((SFc3_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_SS6_Estimation2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_SS6_Estimation2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_SS6_Estimation2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_SS6_Estimation2(SimStruct *S)
{
  SFc3_SS6_Estimation2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_SS6_Estimation2InstanceStruct *)utMalloc(sizeof
    (SFc3_SS6_Estimation2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_SS6_Estimation2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_SS6_Estimation2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_SS6_Estimation2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_SS6_Estimation2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_SS6_Estimation2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_SS6_Estimation2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_SS6_Estimation2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_SS6_Estimation2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_SS6_Estimation2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_SS6_Estimation2;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_SS6_Estimation2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_SS6_Estimation2;
...
void c3_SS6_Estimation2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_SS6_Estimation2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_SS6_Estimation2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_SS6_Estimation2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_SS6_Estimation2_method_dispatcher.\n"
