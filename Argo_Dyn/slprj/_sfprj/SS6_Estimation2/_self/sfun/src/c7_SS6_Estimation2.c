...
static const char * c7_debug_family_names[65] = { "M", "Ms", "Izz", "Ixx", "Ixz",
...
static void initialize_c7_SS6_Estimation2(SFc7_SS6_Estimation2InstanceStruct
  *chartInstance);
static void initialize_params_c7_SS6_Estimation2
  (SFc7_SS6_Estimation2InstanceStruct *chartInstance);
static void enable_c7_SS6_Estimation2(SFc7_SS6_Estimation2InstanceStruct
  *chartInstance);
static void disable_c7_SS6_Estimation2(SFc7_SS6_Estimation2InstanceStruct
  *chartInstance);
static void c7_update_debugger_state_c7_SS6_Estimation2
  (SFc7_SS6_Estimation2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_SS6_Estimation2
  (SFc7_SS6_Estimation2InstanceStruct *chartInstance);
static void set_sim_state_c7_SS6_Estimation2(SFc7_SS6_Estimation2InstanceStruct *
  chartInstance, const mxArray *c7_st);
static void finalize_c7_SS6_Estimation2(SFc7_SS6_Estimation2InstanceStruct
  *chartInstance);
static void sf_gateway_c7_SS6_Estimation2(SFc7_SS6_Estimation2InstanceStruct
  *chartInstance);
static void mdl_start_c7_SS6_Estimation2(SFc7_SS6_Estimation2InstanceStruct
  *chartInstance);
static void c7_chartstep_c7_SS6_Estimation2(SFc7_SS6_Estimation2InstanceStruct
  *chartInstance);
static void initSimStructsc7_SS6_Estimation2(SFc7_SS6_Estimation2InstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber, uint32_T c7_instanceNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static real_T c7_emlrt_marshallIn(SFc7_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c7_b_F_SL_m, const char_T *c7_identifier);
static real_T c7_b_emlrt_marshallIn(SFc7_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_c_emlrt_marshallIn(SFc7_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[6]);
...
static real_T c7_sqrt(SFc7_SS6_Estimation2InstanceStruct *chartInstance, real_T
                      c7_x);
static void c7_eml_error(SFc7_SS6_Estimation2InstanceStruct *chartInstance);
static const mxArray *c7_c_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_d_emlrt_marshallIn(SFc7_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_e_emlrt_marshallIn(SFc7_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c7_b_is_active_c7_SS6_Estimation2, const char_T
  *c7_identifier);
static uint8_T c7_f_emlrt_marshallIn(SFc7_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_sqrt(SFc7_SS6_Estimation2InstanceStruct *chartInstance, real_T *
                      c7_x);
static void init_dsm_address_info(SFc7_SS6_Estimation2InstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc7_SS6_Estimation2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_SS6_Estimation2 = 0U;
}
  ...
  (SFc7_SS6_Estimation2InstanceStruct *chartInstance)
{
  ...
  c7_i_hoistedGlobal = chartInstance->c7_is_active_c7_SS6_Estimation2;
  ...
  chartInstance, const mxArray *c7_st)
{
  ...
  *chartInstance->c7_a_rL = c7_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c7_is_active_c7_SS6_Estimation2 = c7_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 8)),
     "is_active_c7_SS6_Estimation2");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_SS6_Estimation2(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c7_sfEvent = CALL_EVENT;
  c7_chartstep_c7_SS6_Estimation2(chartInstance);
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c7_r, 6U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c7_a_fL, 7U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c7_a_rL, 8U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c7_a_mL, 9U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c7_F_SL_f, 10U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c7_F_SL_r, 11U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c7_F_SL_m, 12U);
}
  ...
  *chartInstance)
{
  ...
  real_T c7_b_Slip;
  real_T c7_b_r;
  uint32_T c7_debug_family_var_map[65];
  real_T c7_M;
  real_T c7_Ms;
  real_T c7_Izz;
  real_T c7_Ixx;
  ...
  c7_e_hoistedGlobal = *chartInstance->c7_r;
  c7_b_FzL = c7_hoistedGlobal;
  c7_b_U = c7_b_hoistedGlobal;
  c7_b_V = c7_c_hoistedGlobal;
  c7_b_Slip = c7_d_hoistedGlobal;
  c7_b_r = c7_e_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 65U, 65U, c7_debug_family_names,
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c7_b_r, 56U, c7_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_b_F_SL, 57U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_b_F_tL, 58U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_b_a_fL, 59U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_b_a_rL, 60U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_b_a_mL, 61U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_b_F_SL_f, 62U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_b_F_SL_r, 63U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c7_b_F_SL_m, 64U, c7_sf_marshallOut,
    c7_sf_marshallIn);
  CV_EML_FCN(0, 0);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_SS6_Estimation2InstanceStruct *chartInstance;
  chartInstance = (SFc7_SS6_Estimation2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c7_SS6_Estimation2_get_eml_resolved_functions_info(void)
{
  ...
  *c7_identifier)
{
  ...
  c7_y = c7_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_SS6_Estimation2), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_SS6_Estimation2);
  return c7_y;
}
...
void sf_c7_SS6_Estimation2_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c7_SS6_Estimation2_get_post_codegen_info(void);
mxArray *sf_c7_SS6_Estimation2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c7_SS6_Estimation2_get_post_codegen_info();
...
mxArray *sf_c7_SS6_Estimation2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_SS6_Estimation2_jit_fallback_info(void)
{
...
mxArray *sf_c7_SS6_Estimation2_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c7_SS6_Estimation2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x9'type','srcId','name','auxInfo'{{M[1],M[5],T\"F_SL\",},{M[1],M[24],T\"F_SL_f\",},{M[1],M[26],T\"F_SL_m\",},{M[1],M[25],T\"F_SL_r\",},{M[1],M[15],T\"F_tL\",},{M[1],M[18],T\"a_fL\",},{M[1],M[21],T\"a_mL\",},{M[1],M[19],T\"a_rL\",},{M[8],M[0],T\"is_active_c7_SS6_Estimation2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 9, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_SS6_Estimation2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc7_SS6_Estimation2InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c7_r);
        _SFD_SET_DATA_VALUE_PTR(7U, chartInstance->c7_a_fL);
        _SFD_SET_DATA_VALUE_PTR(8U, chartInstance->c7_a_rL);
        _SFD_SET_DATA_VALUE_PTR(9U, chartInstance->c7_a_mL);
        _SFD_SET_DATA_VALUE_PTR(10U, chartInstance->c7_F_SL_f);
        _SFD_SET_DATA_VALUE_PTR(11U, chartInstance->c7_F_SL_r);
        _SFD_SET_DATA_VALUE_PTR(12U, chartInstance->c7_F_SL_m);
      }
    } else {
...
static void sf_opaque_initialize_c7_SS6_Estimation2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_SS6_Estimation2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_SS6_Estimation2((SFc7_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
  initialize_c7_SS6_Estimation2((SFc7_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c7_SS6_Estimation2(void *chartInstanceVar)
{
  enable_c7_SS6_Estimation2((SFc7_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c7_SS6_Estimation2(void *chartInstanceVar)
{
  disable_c7_SS6_Estimation2((SFc7_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c7_SS6_Estimation2(void *chartInstanceVar)
{
  sf_gateway_c7_SS6_Estimation2((SFc7_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c7_SS6_Estimation2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c7_SS6_Estimation2((SFc7_SS6_Estimation2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c7_SS6_Estimation2(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c7_SS6_Estimation2((SFc7_SS6_Estimation2InstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c7_SS6_Estimation2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_SS6_Estimation2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c7_SS6_Estimation2((SFc7_SS6_Estimation2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc7_SS6_Estimation2((SFc7_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_SS6_Estimation2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c7_SS6_Estimation2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c7_SS6_Estimation2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_SS6_Estimation2(SimStruct *S)
{
  SFc7_SS6_Estimation2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc7_SS6_Estimation2InstanceStruct *)utMalloc(sizeof
    (SFc7_SS6_Estimation2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_SS6_Estimation2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_SS6_Estimation2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_SS6_Estimation2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_SS6_Estimation2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_SS6_Estimation2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c7_SS6_Estimation2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_SS6_Estimation2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_SS6_Estimation2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_SS6_Estimation2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_SS6_Estimation2;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_SS6_Estimation2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_SS6_Estimation2;
...
void c7_SS6_Estimation2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_SS6_Estimation2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_SS6_Estimation2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_SS6_Estimation2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_SS6_Estimation2_method_dispatcher.\n"
