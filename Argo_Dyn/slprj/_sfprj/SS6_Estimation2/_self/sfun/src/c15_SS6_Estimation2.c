...
static void initialize_c15_SS6_Estimation2(SFc15_SS6_Estimation2InstanceStruct
  *chartInstance);
static void initialize_params_c15_SS6_Estimation2
  (SFc15_SS6_Estimation2InstanceStruct *chartInstance);
static void enable_c15_SS6_Estimation2(SFc15_SS6_Estimation2InstanceStruct
  *chartInstance);
static void disable_c15_SS6_Estimation2(SFc15_SS6_Estimation2InstanceStruct
  *chartInstance);
static void c15_update_debugger_state_c15_SS6_Estimation2
  (SFc15_SS6_Estimation2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c15_SS6_Estimation2
  (SFc15_SS6_Estimation2InstanceStruct *chartInstance);
static void set_sim_state_c15_SS6_Estimation2
  (SFc15_SS6_Estimation2InstanceStruct *chartInstance, const mxArray *c15_st);
static void finalize_c15_SS6_Estimation2(SFc15_SS6_Estimation2InstanceStruct
  *chartInstance);
static void sf_gateway_c15_SS6_Estimation2(SFc15_SS6_Estimation2InstanceStruct
  *chartInstance);
static void mdl_start_c15_SS6_Estimation2(SFc15_SS6_Estimation2InstanceStruct
  *chartInstance);
static void c15_chartstep_c15_SS6_Estimation2
  (SFc15_SS6_Estimation2InstanceStruct *chartInstance);
static void initSimStructsc15_SS6_Estimation2
  (SFc15_SS6_Estimation2InstanceStruct *chartInstance);
...
static const mxArray *c15_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static real_T c15_emlrt_marshallIn(SFc15_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c15_b_F_SR_m, const char_T *c15_identifier);
static real_T c15_b_emlrt_marshallIn(SFc15_SS6_Estimation2InstanceStruct
...
static const mxArray *c15_b_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static void c15_c_emlrt_marshallIn(SFc15_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId,
  real_T c15_y[6]);
...
static real_T c15_sqrt(SFc15_SS6_Estimation2InstanceStruct *chartInstance,
  real_T c15_x);
static void c15_eml_error(SFc15_SS6_Estimation2InstanceStruct *chartInstance);
static const mxArray *c15_c_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static int32_T c15_d_emlrt_marshallIn(SFc15_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void c15_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c15_mxArrayInData, const char_T *c15_varName, void *c15_outData);
static uint8_T c15_e_emlrt_marshallIn(SFc15_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c15_b_is_active_c15_SS6_Estimation2, const
  char_T *c15_identifier);
static uint8_T c15_f_emlrt_marshallIn(SFc15_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void c15_b_sqrt(SFc15_SS6_Estimation2InstanceStruct *chartInstance,
  real_T *c15_x);
static void init_dsm_address_info(SFc15_SS6_Estimation2InstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc15_SS6_Estimation2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c15_is_active_c15_SS6_Estimation2 = 0U;
}
  ...
  (SFc15_SS6_Estimation2InstanceStruct *chartInstance)
{
  ...
  c15_i_hoistedGlobal = chartInstance->c15_is_active_c15_SS6_Estimation2;
  ...
  (SFc15_SS6_Estimation2InstanceStruct *chartInstance, const mxArray *c15_st)
{
  ...
  *chartInstance->c15_a_rR = c15_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c15_is_active_c15_SS6_Estimation2 = c15_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c15_u, 8)),
     "is_active_c15_SS6_Estimation2");
  sf_mex_destroy(&c15_u);
  c15_update_debugger_state_c15_SS6_Estimation2(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c15_sfEvent = CALL_EVENT;
  c15_chartstep_c15_SS6_Estimation2(chartInstance);
  ...
  *c15_inData)
{
  ...
  const mxArray *c15_y = NULL;
  SFc15_SS6_Estimation2InstanceStruct *chartInstance;
  chartInstance = (SFc15_SS6_Estimation2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c15_SS6_Estimation2_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c15_identifier)
{
  ...
  c15_y = c15_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c15_b_is_active_c15_SS6_Estimation2), &c15_thisId);
  sf_mex_destroy(&c15_b_is_active_c15_SS6_Estimation2);
  return c15_y;
}
...
void sf_c15_SS6_Estimation2_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c15_SS6_Estimation2_get_post_codegen_info(void);
mxArray *sf_c15_SS6_Estimation2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c15_SS6_Estimation2_get_post_codegen_info();
...
mxArray *sf_c15_SS6_Estimation2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c15_SS6_Estimation2_jit_fallback_info(void)
{
...
mxArray *sf_c15_SS6_Estimation2_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c15_SS6_Estimation2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x9'type','srcId','name','auxInfo'{{M[1],M[5],T\"F_SR\",},{M[1],M[25],T\"F_SR_f\",},{M[1],M[27],T\"F_SR_m\",},{M[1],M[26],T\"F_SR_r\",},{M[1],M[15],T\"F_tR\",},{M[1],M[18],T\"a_fR\",},{M[1],M[21],T\"a_mR\",},{M[1],M[19],T\"a_rR\",},{M[8],M[0],T\"is_active_c15_SS6_Estimation2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 9, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c15_SS6_Estimation2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc15_SS6_Estimation2InstanceStruct *)
...
static void sf_opaque_initialize_c15_SS6_Estimation2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc15_SS6_Estimation2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c15_SS6_Estimation2((SFc15_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
  initialize_c15_SS6_Estimation2((SFc15_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c15_SS6_Estimation2(void *chartInstanceVar)
{
  enable_c15_SS6_Estimation2((SFc15_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c15_SS6_Estimation2(void *chartInstanceVar)
{
  disable_c15_SS6_Estimation2((SFc15_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c15_SS6_Estimation2(void *chartInstanceVar)
{
  sf_gateway_c15_SS6_Estimation2((SFc15_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c15_SS6_Estimation2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c15_SS6_Estimation2((SFc15_SS6_Estimation2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c15_SS6_Estimation2(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c15_SS6_Estimation2((SFc15_SS6_Estimation2InstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c15_SS6_Estimation2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc15_SS6_Estimation2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c15_SS6_Estimation2((SFc15_SS6_Estimation2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc15_SS6_Estimation2((SFc15_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c15_SS6_Estimation2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c15_SS6_Estimation2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c15_SS6_Estimation2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c15_SS6_Estimation2(SimStruct *S)
{
  SFc15_SS6_Estimation2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc15_SS6_Estimation2InstanceStruct *)utMalloc(sizeof
    (SFc15_SS6_Estimation2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc15_SS6_Estimation2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c15_SS6_Estimation2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c15_SS6_Estimation2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c15_SS6_Estimation2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c15_SS6_Estimation2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c15_SS6_Estimation2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c15_SS6_Estimation2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c15_SS6_Estimation2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c15_SS6_Estimation2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c15_SS6_Estimation2;
  chartInstance->chartInfo.mdlStart = mdlStart_c15_SS6_Estimation2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c15_SS6_Estimation2;
...
void c15_SS6_Estimation2_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c15_SS6_Estimation2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c15_SS6_Estimation2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c15_SS6_Estimation2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c15_SS6_Estimation2_method_dispatcher.\n"
