...
static void initialize_c16_SS6_Estimation2(SFc16_SS6_Estimation2InstanceStruct
  *chartInstance);
static void initialize_params_c16_SS6_Estimation2
  (SFc16_SS6_Estimation2InstanceStruct *chartInstance);
static void enable_c16_SS6_Estimation2(SFc16_SS6_Estimation2InstanceStruct
  *chartInstance);
static void disable_c16_SS6_Estimation2(SFc16_SS6_Estimation2InstanceStruct
  *chartInstance);
static void c16_update_debugger_state_c16_SS6_Estimation2
  (SFc16_SS6_Estimation2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c16_SS6_Estimation2
  (SFc16_SS6_Estimation2InstanceStruct *chartInstance);
static void set_sim_state_c16_SS6_Estimation2
  (SFc16_SS6_Estimation2InstanceStruct *chartInstance, const mxArray *c16_st);
static void finalize_c16_SS6_Estimation2(SFc16_SS6_Estimation2InstanceStruct
  *chartInstance);
static void sf_gateway_c16_SS6_Estimation2(SFc16_SS6_Estimation2InstanceStruct
  *chartInstance);
static void mdl_start_c16_SS6_Estimation2(SFc16_SS6_Estimation2InstanceStruct
  *chartInstance);
static void c16_chartstep_c16_SS6_Estimation2
  (SFc16_SS6_Estimation2InstanceStruct *chartInstance);
static void initSimStructsc16_SS6_Estimation2
  (SFc16_SS6_Estimation2InstanceStruct *chartInstance);
...
static const mxArray *c16_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static real_T c16_emlrt_marshallIn(SFc16_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c16_b_Fz_R, const char_T *c16_identifier);
static real_T c16_b_emlrt_marshallIn(SFc16_SS6_Estimation2InstanceStruct
...
static const mxArray *c16_b_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static int32_T c16_c_emlrt_marshallIn(SFc16_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void c16_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData);
static uint8_T c16_d_emlrt_marshallIn(SFc16_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c16_b_is_active_c16_SS6_Estimation2, const
  char_T *c16_identifier);
static uint8_T c16_e_emlrt_marshallIn(SFc16_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void init_dsm_address_info(SFc16_SS6_Estimation2InstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc16_SS6_Estimation2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c16_is_active_c16_SS6_Estimation2 = 0U;
}
  ...
  (SFc16_SS6_Estimation2InstanceStruct *chartInstance)
{
  ...
  c16_c_hoistedGlobal = chartInstance->c16_is_active_c16_SS6_Estimation2;
  ...
  (SFc16_SS6_Estimation2InstanceStruct *chartInstance, const mxArray *c16_st)
{
  ...
  *chartInstance->c16_Fz_R = c16_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c16_is_active_c16_SS6_Estimation2 = c16_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c16_u, 2)),
     "is_active_c16_SS6_Estimation2");
  sf_mex_destroy(&c16_u);
  c16_update_debugger_state_c16_SS6_Estimation2(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c16_sfEvent = CALL_EVENT;
  c16_chartstep_c16_SS6_Estimation2(chartInstance);
  ...
  *c16_inData)
{
  ...
  const mxArray *c16_y = NULL;
  SFc16_SS6_Estimation2InstanceStruct *chartInstance;
  chartInstance = (SFc16_SS6_Estimation2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c16_SS6_Estimation2_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c16_identifier)
{
  ...
  c16_y = c16_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c16_b_is_active_c16_SS6_Estimation2), &c16_thisId);
  sf_mex_destroy(&c16_b_is_active_c16_SS6_Estimation2);
  return c16_y;
}
...
void sf_c16_SS6_Estimation2_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c16_SS6_Estimation2_get_post_codegen_info(void);
mxArray *sf_c16_SS6_Estimation2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c16_SS6_Estimation2_get_post_codegen_info();
...
mxArray *sf_c16_SS6_Estimation2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c16_SS6_Estimation2_jit_fallback_info(void)
{
...
mxArray *sf_c16_SS6_Estimation2_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c16_SS6_Estimation2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"Fz_L\",},{M[1],M[15],T\"Fz_R\",},{M[8],M[0],T\"is_active_c16_SS6_Estimation2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c16_SS6_Estimation2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc16_SS6_Estimation2InstanceStruct *)
...
static void sf_opaque_initialize_c16_SS6_Estimation2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc16_SS6_Estimation2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c16_SS6_Estimation2((SFc16_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
  initialize_c16_SS6_Estimation2((SFc16_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c16_SS6_Estimation2(void *chartInstanceVar)
{
  enable_c16_SS6_Estimation2((SFc16_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c16_SS6_Estimation2(void *chartInstanceVar)
{
  disable_c16_SS6_Estimation2((SFc16_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c16_SS6_Estimation2(void *chartInstanceVar)
{
  sf_gateway_c16_SS6_Estimation2((SFc16_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c16_SS6_Estimation2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c16_SS6_Estimation2((SFc16_SS6_Estimation2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c16_SS6_Estimation2(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c16_SS6_Estimation2((SFc16_SS6_Estimation2InstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c16_SS6_Estimation2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc16_SS6_Estimation2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c16_SS6_Estimation2((SFc16_SS6_Estimation2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc16_SS6_Estimation2((SFc16_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c16_SS6_Estimation2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c16_SS6_Estimation2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c16_SS6_Estimation2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c16_SS6_Estimation2(SimStruct *S)
{
  SFc16_SS6_Estimation2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc16_SS6_Estimation2InstanceStruct *)utMalloc(sizeof
    (SFc16_SS6_Estimation2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc16_SS6_Estimation2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c16_SS6_Estimation2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c16_SS6_Estimation2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c16_SS6_Estimation2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c16_SS6_Estimation2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c16_SS6_Estimation2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c16_SS6_Estimation2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c16_SS6_Estimation2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c16_SS6_Estimation2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c16_SS6_Estimation2;
  chartInstance->chartInfo.mdlStart = mdlStart_c16_SS6_Estimation2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c16_SS6_Estimation2;
...
void c16_SS6_Estimation2_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c16_SS6_Estimation2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c16_SS6_Estimation2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c16_SS6_Estimation2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c16_SS6_Estimation2_method_dispatcher.\n"
