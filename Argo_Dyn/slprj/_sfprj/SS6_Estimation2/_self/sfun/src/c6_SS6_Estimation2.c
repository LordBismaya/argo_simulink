...
static void initialize_c6_SS6_Estimation2(SFc6_SS6_Estimation2InstanceStruct
  *chartInstance);
static void initialize_params_c6_SS6_Estimation2
  (SFc6_SS6_Estimation2InstanceStruct *chartInstance);
static void enable_c6_SS6_Estimation2(SFc6_SS6_Estimation2InstanceStruct
  *chartInstance);
static void disable_c6_SS6_Estimation2(SFc6_SS6_Estimation2InstanceStruct
  *chartInstance);
static void c6_update_debugger_state_c6_SS6_Estimation2
  (SFc6_SS6_Estimation2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_SS6_Estimation2
  (SFc6_SS6_Estimation2InstanceStruct *chartInstance);
static void set_sim_state_c6_SS6_Estimation2(SFc6_SS6_Estimation2InstanceStruct *
  chartInstance, const mxArray *c6_st);
static void finalize_c6_SS6_Estimation2(SFc6_SS6_Estimation2InstanceStruct
  *chartInstance);
static void sf_gateway_c6_SS6_Estimation2(SFc6_SS6_Estimation2InstanceStruct
  *chartInstance);
static void mdl_start_c6_SS6_Estimation2(SFc6_SS6_Estimation2InstanceStruct
  *chartInstance);
static void c6_chartstep_c6_SS6_Estimation2(SFc6_SS6_Estimation2InstanceStruct
  *chartInstance);
static void initSimStructsc6_SS6_Estimation2(SFc6_SS6_Estimation2InstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static real_T c6_emlrt_marshallIn(SFc6_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c6_b_Fz_R, const char_T *c6_identifier);
static real_T c6_b_emlrt_marshallIn(SFc6_SS6_Estimation2InstanceStruct
...
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_c_emlrt_marshallIn(SFc6_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_d_emlrt_marshallIn(SFc6_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c6_b_is_active_c6_SS6_Estimation2, const char_T
  *c6_identifier);
static uint8_T c6_e_emlrt_marshallIn(SFc6_SS6_Estimation2InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_SS6_Estimation2InstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc6_SS6_Estimation2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_SS6_Estimation2 = 0U;
}
  ...
  (SFc6_SS6_Estimation2InstanceStruct *chartInstance)
{
  ...
  c6_c_hoistedGlobal = chartInstance->c6_is_active_c6_SS6_Estimation2;
  ...
  chartInstance, const mxArray *c6_st)
{
  ...
  *chartInstance->c6_Fz_R = c6_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c6_is_active_c6_SS6_Estimation2 = c6_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 2)),
     "is_active_c6_SS6_Estimation2");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_SS6_Estimation2(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c6_sfEvent = CALL_EVENT;
  c6_chartstep_c6_SS6_Estimation2(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_SS6_Estimation2InstanceStruct *chartInstance;
  chartInstance = (SFc6_SS6_Estimation2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c6_SS6_Estimation2_get_eml_resolved_functions_info(void)
{
  ...
  *c6_identifier)
{
  ...
  c6_y = c6_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_SS6_Estimation2), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_SS6_Estimation2);
  return c6_y;
}
...
void sf_c6_SS6_Estimation2_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c6_SS6_Estimation2_get_post_codegen_info(void);
mxArray *sf_c6_SS6_Estimation2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c6_SS6_Estimation2_get_post_codegen_info();
...
mxArray *sf_c6_SS6_Estimation2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_SS6_Estimation2_jit_fallback_info(void)
{
...
mxArray *sf_c6_SS6_Estimation2_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c6_SS6_Estimation2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"Fz_L\",},{M[1],M[15],T\"Fz_R\",},{M[8],M[0],T\"is_active_c6_SS6_Estimation2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_SS6_Estimation2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_SS6_Estimation2InstanceStruct *)
...
static void sf_opaque_initialize_c6_SS6_Estimation2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_SS6_Estimation2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_SS6_Estimation2((SFc6_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
  initialize_c6_SS6_Estimation2((SFc6_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c6_SS6_Estimation2(void *chartInstanceVar)
{
  enable_c6_SS6_Estimation2((SFc6_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c6_SS6_Estimation2(void *chartInstanceVar)
{
  disable_c6_SS6_Estimation2((SFc6_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c6_SS6_Estimation2(void *chartInstanceVar)
{
  sf_gateway_c6_SS6_Estimation2((SFc6_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c6_SS6_Estimation2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c6_SS6_Estimation2((SFc6_SS6_Estimation2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c6_SS6_Estimation2(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c6_SS6_Estimation2((SFc6_SS6_Estimation2InstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c6_SS6_Estimation2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_SS6_Estimation2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_SS6_Estimation2((SFc6_SS6_Estimation2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc6_SS6_Estimation2((SFc6_SS6_Estimation2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_SS6_Estimation2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_SS6_Estimation2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c6_SS6_Estimation2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_SS6_Estimation2(SimStruct *S)
{
  SFc6_SS6_Estimation2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_SS6_Estimation2InstanceStruct *)utMalloc(sizeof
    (SFc6_SS6_Estimation2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_SS6_Estimation2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_SS6_Estimation2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_SS6_Estimation2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_SS6_Estimation2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_SS6_Estimation2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_SS6_Estimation2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_SS6_Estimation2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_SS6_Estimation2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_SS6_Estimation2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_SS6_Estimation2;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_SS6_Estimation2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_SS6_Estimation2;
...
void c6_SS6_Estimation2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_SS6_Estimation2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_SS6_Estimation2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_SS6_Estimation2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_SS6_Estimation2_method_dispatcher.\n"
