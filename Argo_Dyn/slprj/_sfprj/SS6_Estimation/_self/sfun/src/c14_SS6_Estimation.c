...
static void initialize_c14_SS6_Estimation(SFc14_SS6_EstimationInstanceStruct
  *chartInstance);
static void initialize_params_c14_SS6_Estimation
  (SFc14_SS6_EstimationInstanceStruct *chartInstance);
static void enable_c14_SS6_Estimation(SFc14_SS6_EstimationInstanceStruct
  *chartInstance);
static void disable_c14_SS6_Estimation(SFc14_SS6_EstimationInstanceStruct
  *chartInstance);
static void c14_update_debugger_state_c14_SS6_Estimation
  (SFc14_SS6_EstimationInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c14_SS6_Estimation
  (SFc14_SS6_EstimationInstanceStruct *chartInstance);
static void set_sim_state_c14_SS6_Estimation(SFc14_SS6_EstimationInstanceStruct *
  chartInstance, const mxArray *c14_st);
static void finalize_c14_SS6_Estimation(SFc14_SS6_EstimationInstanceStruct
  *chartInstance);
static void sf_gateway_c14_SS6_Estimation(SFc14_SS6_EstimationInstanceStruct
  *chartInstance);
static void mdl_start_c14_SS6_Estimation(SFc14_SS6_EstimationInstanceStruct
  *chartInstance);
static void c14_chartstep_c14_SS6_Estimation(SFc14_SS6_EstimationInstanceStruct *
  chartInstance);
static void initSimStructsc14_SS6_Estimation(SFc14_SS6_EstimationInstanceStruct *
  chartInstance);
...
static const mxArray *c14_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static real_T c14_emlrt_marshallIn(SFc14_SS6_EstimationInstanceStruct
  *chartInstance, const mxArray *c14_b_F_SL_m, const char_T *c14_identifier);
static real_T c14_b_emlrt_marshallIn(SFc14_SS6_EstimationInstanceStruct
...
static const mxArray *c14_b_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static void c14_c_emlrt_marshallIn(SFc14_SS6_EstimationInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId,
  real_T c14_y[6]);
...
static real_T c14_sqrt(SFc14_SS6_EstimationInstanceStruct *chartInstance, real_T
  c14_x);
static void c14_eml_error(SFc14_SS6_EstimationInstanceStruct *chartInstance);
static const mxArray *c14_c_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static int32_T c14_d_emlrt_marshallIn(SFc14_SS6_EstimationInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void c14_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c14_mxArrayInData, const char_T *c14_varName, void *c14_outData);
static uint8_T c14_e_emlrt_marshallIn(SFc14_SS6_EstimationInstanceStruct
  *chartInstance, const mxArray *c14_b_is_active_c14_SS6_Estimation, const
  char_T *c14_identifier);
static uint8_T c14_f_emlrt_marshallIn(SFc14_SS6_EstimationInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void c14_b_sqrt(SFc14_SS6_EstimationInstanceStruct *chartInstance, real_T
  *c14_x);
static void init_dsm_address_info(SFc14_SS6_EstimationInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc14_SS6_EstimationInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c14_is_active_c14_SS6_Estimation = 0U;
}
  ...
  (SFc14_SS6_EstimationInstanceStruct *chartInstance)
{
  ...
  c14_i_hoistedGlobal = chartInstance->c14_is_active_c14_SS6_Estimation;
  ...
  chartInstance, const mxArray *c14_st)
{
  ...
  *chartInstance->c14_a_rL = c14_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c14_is_active_c14_SS6_Estimation = c14_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c14_u, 8)),
     "is_active_c14_SS6_Estimation");
  sf_mex_destroy(&c14_u);
  c14_update_debugger_state_c14_SS6_Estimation(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c14_sfEvent = CALL_EVENT;
  c14_chartstep_c14_SS6_Estimation(chartInstance);
  ...
  *c14_inData)
{
  ...
  const mxArray *c14_y = NULL;
  SFc14_SS6_EstimationInstanceStruct *chartInstance;
  chartInstance = (SFc14_SS6_EstimationInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c14_SS6_Estimation_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c14_identifier)
{
  ...
  c14_y = c14_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c14_b_is_active_c14_SS6_Estimation), &c14_thisId);
  sf_mex_destroy(&c14_b_is_active_c14_SS6_Estimation);
  return c14_y;
}
...
void sf_c14_SS6_Estimation_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c14_SS6_Estimation_get_post_codegen_info(void);
mxArray *sf_c14_SS6_Estimation_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c14_SS6_Estimation_get_post_codegen_info();
...
mxArray *sf_c14_SS6_Estimation_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c14_SS6_Estimation_jit_fallback_info(void)
{
...
mxArray *sf_c14_SS6_Estimation_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c14_SS6_Estimation(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x9'type','srcId','name','auxInfo'{{M[1],M[5],T\"F_SL\",},{M[1],M[24],T\"F_SL_f\",},{M[1],M[26],T\"F_SL_m\",},{M[1],M[25],T\"F_SL_r\",},{M[1],M[15],T\"F_tL\",},{M[1],M[18],T\"a_fL\",},{M[1],M[21],T\"a_mL\",},{M[1],M[19],T\"a_rL\",},{M[8],M[0],T\"is_active_c14_SS6_Estimation\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 9, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c14_SS6_Estimation_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc14_SS6_EstimationInstanceStruct *)
...
static void sf_opaque_initialize_c14_SS6_Estimation(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc14_SS6_EstimationInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c14_SS6_Estimation((SFc14_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
  initialize_c14_SS6_Estimation((SFc14_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c14_SS6_Estimation(void *chartInstanceVar)
{
  enable_c14_SS6_Estimation((SFc14_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c14_SS6_Estimation(void *chartInstanceVar)
{
  disable_c14_SS6_Estimation((SFc14_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c14_SS6_Estimation(void *chartInstanceVar)
{
  sf_gateway_c14_SS6_Estimation((SFc14_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c14_SS6_Estimation(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c14_SS6_Estimation((SFc14_SS6_EstimationInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c14_SS6_Estimation(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c14_SS6_Estimation((SFc14_SS6_EstimationInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c14_SS6_Estimation(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc14_SS6_EstimationInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c14_SS6_Estimation((SFc14_SS6_EstimationInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc14_SS6_Estimation((SFc14_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c14_SS6_Estimation(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c14_SS6_Estimation(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c14_SS6_Estimation(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c14_SS6_Estimation(SimStruct *S)
{
  SFc14_SS6_EstimationInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc14_SS6_EstimationInstanceStruct *)utMalloc(sizeof
    (SFc14_SS6_EstimationInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc14_SS6_EstimationInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c14_SS6_Estimation;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c14_SS6_Estimation;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c14_SS6_Estimation;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c14_SS6_Estimation;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c14_SS6_Estimation;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c14_SS6_Estimation;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c14_SS6_Estimation;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c14_SS6_Estimation;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c14_SS6_Estimation;
  chartInstance->chartInfo.mdlStart = mdlStart_c14_SS6_Estimation;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c14_SS6_Estimation;
...
void c14_SS6_Estimation_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c14_SS6_Estimation(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c14_SS6_Estimation(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c14_SS6_Estimation(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c14_SS6_Estimation_method_dispatcher.\n"
