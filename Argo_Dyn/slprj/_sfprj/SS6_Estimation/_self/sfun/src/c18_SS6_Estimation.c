...
static const char * c18_debug_family_names[20] = { "nargin", "nargout",
  "aXM_IMU", "aYM_IMU", "rM_IMU", "U_dot", "V_dot", "r_dot", "UM_dot", "VM_dot",
  "rM_dot", "V1", "V2", "V3", "V4", "V5", "V6", "aX", "aY", "r" };
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c18_b_r_dot, 7U, c18_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c18_b_UM_dot, 8U, c18_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c18_b_VM_dot, 9U, c18_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c18_b_rM_dot, 10U, c18_sf_marshallOut);
  ...
  c18_b_r = c18_b_rM_IMU + c18_l_y * (c18_b_r_dot - c18_b_rM_dot);
  _SFD_EML_CALL(0U, chartInstance->c18_sfEvent, -4);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3585368170U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1887726999U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2645815466U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2156405280U);
}
...
mxArray *sf_c18_SS6_Estimation_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("YXszWpDLBtReYgWOu3qNwC");
...
static void mdlSetWorkWidths_c18_SS6_Estimation(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(486207803U));
  ssSetChecksum1(S,(3537295397U));
  ssSetChecksum2(S,(2283313707U));
  ssSetChecksum3(S,(3905044284U));
