...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(806242213U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1473190670U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2822167349U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2852273192U);
}
...
mxArray *sf_c3_SS_jun_25_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("pMRPy6tu8hzaboOxTB6dxF");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1717);
        _SFD_CV_INIT_EML_IF(0,1,0,896,905,927,946);
        _SFD_CV_INIT_EML_IF(0,1,1,1193,1202,1224,1243);
        _SFD_CV_INIT_EML_IF(0,1,2,1492,1501,1523,1542);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,899,904,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,1,1196,1201,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,2,1495,1500,-1,2);
...
static void mdlSetWorkWidths_c3_SS_jun_25(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2058318114U));
  ssSetChecksum1(S,(656132572U));
  ssSetChecksum2(S,(340047978U));
  ssSetChecksum3(S,(4018696129U));
