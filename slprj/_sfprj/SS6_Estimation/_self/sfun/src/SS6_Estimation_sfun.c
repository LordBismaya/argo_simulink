  ...
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1532659114U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2380320517U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(335531036U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3831725965U);
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 4:
      {
        if (strcmp(aiChksum, "Sa2x7C4F5jUQ1wd5cd4EHF") == 0) {
     ...
     case 18:
      {
        if (strcmp(aiChksum, "U43TkRvySL7LKANR05LMhF") == 0) {
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 4:
      {
        if (strcmp(tpChksum, "em4yqpwN8XaR96EdzoDm2") == 0) {
     ...
     case 18:
      {
        if (strcmp(tpChksum, "tK3dTgvy7FyQPZGnhLaa9E") == 0) {
