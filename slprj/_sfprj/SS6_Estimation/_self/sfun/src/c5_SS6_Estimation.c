...
static void initialize_c5_SS6_Estimation(SFc5_SS6_EstimationInstanceStruct
  *chartInstance);
static void initialize_params_c5_SS6_Estimation
  (SFc5_SS6_EstimationInstanceStruct *chartInstance);
static void enable_c5_SS6_Estimation(SFc5_SS6_EstimationInstanceStruct
  *chartInstance);
static void disable_c5_SS6_Estimation(SFc5_SS6_EstimationInstanceStruct
  *chartInstance);
static void c5_update_debugger_state_c5_SS6_Estimation
  (SFc5_SS6_EstimationInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_SS6_Estimation
  (SFc5_SS6_EstimationInstanceStruct *chartInstance);
static void set_sim_state_c5_SS6_Estimation(SFc5_SS6_EstimationInstanceStruct
  *chartInstance, const mxArray *c5_st);
static void finalize_c5_SS6_Estimation(SFc5_SS6_EstimationInstanceStruct
  *chartInstance);
static void sf_gateway_c5_SS6_Estimation(SFc5_SS6_EstimationInstanceStruct
  *chartInstance);
static void mdl_start_c5_SS6_Estimation(SFc5_SS6_EstimationInstanceStruct
  *chartInstance);
static void c5_chartstep_c5_SS6_Estimation(SFc5_SS6_EstimationInstanceStruct
  *chartInstance);
static void initSimStructsc5_SS6_Estimation(SFc5_SS6_EstimationInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_SS6_EstimationInstanceStruct
  *chartInstance, const mxArray *c5_b_Slip_r, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_SS6_EstimationInstanceStruct
...
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_c_emlrt_marshallIn(SFc5_SS6_EstimationInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_d_emlrt_marshallIn(SFc5_SS6_EstimationInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_SS6_Estimation, const char_T *
  c5_identifier);
static uint8_T c5_e_emlrt_marshallIn(SFc5_SS6_EstimationInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_SS6_EstimationInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc5_SS6_EstimationInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_SS6_Estimation = 0U;
}
  ...
  (SFc5_SS6_EstimationInstanceStruct *chartInstance)
{
  ...
  c5_c_hoistedGlobal = chartInstance->c5_is_active_c5_SS6_Estimation;
  ...
  *chartInstance, const mxArray *c5_st)
{
  ...
  *chartInstance->c5_Slip_r = c5_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c5_is_active_c5_SS6_Estimation = c5_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 2)),
     "is_active_c5_SS6_Estimation");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_SS6_Estimation(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_SS6_Estimation(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_SS6_EstimationInstanceStruct *chartInstance;
  chartInstance = (SFc5_SS6_EstimationInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_SS6_Estimation_get_eml_resolved_functions_info(void)
{
  ...
  c5_identifier)
{
  ...
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_SS6_Estimation), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_SS6_Estimation);
  return c5_y;
}
...
void sf_c5_SS6_Estimation_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c5_SS6_Estimation_get_post_codegen_info(void);
mxArray *sf_c5_SS6_Estimation_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c5_SS6_Estimation_get_post_codegen_info();
...
mxArray *sf_c5_SS6_Estimation_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_SS6_Estimation_jit_fallback_info(void)
{
...
mxArray *sf_c5_SS6_Estimation_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_SS6_Estimation(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"Slip_l\",},{M[1],M[15],T\"Slip_r\",},{M[8],M[0],T\"is_active_c5_SS6_Estimation\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_SS6_Estimation_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_SS6_EstimationInstanceStruct *)
...
static void sf_opaque_initialize_c5_SS6_Estimation(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_SS6_EstimationInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_SS6_Estimation((SFc5_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
  initialize_c5_SS6_Estimation((SFc5_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c5_SS6_Estimation(void *chartInstanceVar)
{
  enable_c5_SS6_Estimation((SFc5_SS6_EstimationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_SS6_Estimation(void *chartInstanceVar)
{
  disable_c5_SS6_Estimation((SFc5_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c5_SS6_Estimation(void *chartInstanceVar)
{
  sf_gateway_c5_SS6_Estimation((SFc5_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c5_SS6_Estimation(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c5_SS6_Estimation((SFc5_SS6_EstimationInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c5_SS6_Estimation(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c5_SS6_Estimation((SFc5_SS6_EstimationInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c5_SS6_Estimation(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_SS6_EstimationInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_SS6_Estimation((SFc5_SS6_EstimationInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc5_SS6_Estimation((SFc5_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_SS6_Estimation(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_SS6_Estimation(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c5_SS6_Estimation(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_SS6_Estimation(SimStruct *S)
{
  SFc5_SS6_EstimationInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_SS6_EstimationInstanceStruct *)utMalloc(sizeof
    (SFc5_SS6_EstimationInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_SS6_EstimationInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_SS6_Estimation;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_SS6_Estimation;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_SS6_Estimation;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_SS6_Estimation;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_SS6_Estimation;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_SS6_Estimation;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_SS6_Estimation;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_SS6_Estimation;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_SS6_Estimation;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_SS6_Estimation;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_SS6_Estimation;
...
void c5_SS6_Estimation_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_SS6_Estimation(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_SS6_Estimation(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_SS6_Estimation(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_SS6_Estimation_method_dispatcher.\n"
