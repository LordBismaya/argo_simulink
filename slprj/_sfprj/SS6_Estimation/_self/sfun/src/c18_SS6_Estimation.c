...
static const char * c18_debug_family_names[20] = { "nargin", "nargout",
  "aXM_IMU", "aYM_IMU", "rM_IMU", "U_dot", "V_dot", "r_eom", "UM_dot", "VM_dot",
  "rM_eom", "V1", "V2", "V3", "V4", "V5", "V6", "aX", "aY", "r" };

/* Function Declarations */
static void initialize_c18_SS6_Estimation(SFc18_SS6_EstimationInstanceStruct
  *chartInstance);
static void initialize_params_c18_SS6_Estimation
  (SFc18_SS6_EstimationInstanceStruct *chartInstance);
static void enable_c18_SS6_Estimation(SFc18_SS6_EstimationInstanceStruct
  *chartInstance);
static void disable_c18_SS6_Estimation(SFc18_SS6_EstimationInstanceStruct
  *chartInstance);
static void c18_update_debugger_state_c18_SS6_Estimation
  (SFc18_SS6_EstimationInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c18_SS6_Estimation
  (SFc18_SS6_EstimationInstanceStruct *chartInstance);
static void set_sim_state_c18_SS6_Estimation(SFc18_SS6_EstimationInstanceStruct *
  chartInstance, const mxArray *c18_st);
static void finalize_c18_SS6_Estimation(SFc18_SS6_EstimationInstanceStruct
  *chartInstance);
static void sf_gateway_c18_SS6_Estimation(SFc18_SS6_EstimationInstanceStruct
  *chartInstance);
static void mdl_start_c18_SS6_Estimation(SFc18_SS6_EstimationInstanceStruct
  *chartInstance);
static void initSimStructsc18_SS6_Estimation(SFc18_SS6_EstimationInstanceStruct *
  chartInstance);
...
static const mxArray *c18_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static real_T c18_emlrt_marshallIn(SFc18_SS6_EstimationInstanceStruct
  *chartInstance, const mxArray *c18_b_r, const char_T *c18_identifier);
static real_T c18_b_emlrt_marshallIn(SFc18_SS6_EstimationInstanceStruct
...
static const mxArray *c18_b_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static int32_T c18_c_emlrt_marshallIn(SFc18_SS6_EstimationInstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void c18_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c18_mxArrayInData, const char_T *c18_varName, void *c18_outData);
static uint8_T c18_d_emlrt_marshallIn(SFc18_SS6_EstimationInstanceStruct
  *chartInstance, const mxArray *c18_b_is_active_c18_SS6_Estimation, const
  char_T *c18_identifier);
static uint8_T c18_e_emlrt_marshallIn(SFc18_SS6_EstimationInstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void init_dsm_address_info(SFc18_SS6_EstimationInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc18_SS6_EstimationInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c18_is_active_c18_SS6_Estimation = 0U;
}
  ...
  (SFc18_SS6_EstimationInstanceStruct *chartInstance)
{
  ...
  c18_d_hoistedGlobal = chartInstance->c18_is_active_c18_SS6_Estimation;
  ...
  chartInstance, const mxArray *c18_st)
{
  ...
  *chartInstance->c18_r = c18_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c18_is_active_c18_SS6_Estimation = c18_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c18_u, 3)),
     "is_active_c18_SS6_Estimation");
  sf_mex_destroy(&c18_u);
  c18_update_debugger_state_c18_SS6_Estimation(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T c18_b_aXM_IMU;
  real_T c18_b_aYM_IMU;
  real_T c18_b_rM_IMU;
  real_T c18_b_U_dot;
  real_T c18_b_V_dot;
  real_T c18_b_r_eom;
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_aXM_IMU, 0U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_aYM_IMU, 1U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_rM_IMU, 2U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_U_dot, 3U);
  chartInstance->c18_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 17U, chartInstance->c18_sfEvent);
  c18_hoistedGlobal = *chartInstance->c18_aXM_IMU;
  c18_b_hoistedGlobal = *chartInstance->c18_aYM_IMU;
  c18_c_hoistedGlobal = *chartInstance->c18_rM_IMU;
  ...
  c18_i_hoistedGlobal = *chartInstance->c18_rM_eom;
  ...
  c18_b_aXM_IMU = c18_hoistedGlobal;
  c18_b_aYM_IMU = c18_b_hoistedGlobal;
  c18_b_rM_IMU = c18_c_hoistedGlobal;
  ...
  c18_b_rM_eom = c18_i_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c18_nargout, 1U, c18_sf_marshallOut,
    c18_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c18_b_aXM_IMU, 2U, c18_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c18_b_aYM_IMU, 3U, c18_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c18_b_rM_IMU, 4U, c18_sf_marshallOut);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c18_b_rM_eom, 10U, c18_sf_marshallOut);
  ...
  guard6 = false;
  if (CV_EML_COND(0, 1, 0, CV_RELATIONAL_EVAL(4U, 0U, 0, c18_b_V1, rtNaN, -1, 0U,
        c18_b_V1 == rtNaN))) {
    guard6 = true;
  } else if (CV_EML_COND(0, 1, 1, CV_RELATIONAL_EVAL(4U, 0U, 1, c18_b_V1, rtInf,
    -1, 0U, c18_b_V1 == rtInf))) {
    guard6 = true;
  } else {
  ...
  guard5 = false;
  if (CV_EML_COND(0, 1, 2, CV_RELATIONAL_EVAL(4U, 0U, 2, c18_b_V2, rtNaN, -1, 0U,
        c18_b_V2 == rtNaN))) {
    guard5 = true;
  } else if (CV_EML_COND(0, 1, 3, CV_RELATIONAL_EVAL(4U, 0U, 3, c18_b_V2, rtInf,
    -1, 0U, c18_b_V2 == rtInf))) {
    guard5 = true;
  } else {
  ...
  guard4 = false;
  if (CV_EML_COND(0, 1, 4, CV_RELATIONAL_EVAL(4U, 0U, 4, c18_b_V3, rtNaN, -1, 0U,
        c18_b_V3 == rtNaN))) {
    guard4 = true;
  } else if (CV_EML_COND(0, 1, 5, CV_RELATIONAL_EVAL(4U, 0U, 5, c18_b_V3, rtInf,
    -1, 0U, c18_b_V3 == rtInf))) {
    guard4 = true;
  } else {
  ...
  guard3 = false;
  if (CV_EML_COND(0, 1, 6, CV_RELATIONAL_EVAL(4U, 0U, 6, c18_b_V4, rtNaN, -1, 0U,
        c18_b_V4 == rtNaN))) {
    guard3 = true;
  } else if (CV_EML_COND(0, 1, 7, CV_RELATIONAL_EVAL(4U, 0U, 7, c18_b_V4, rtInf,
    -1, 0U, c18_b_V4 == rtInf))) {
    guard3 = true;
  } else {
  ...
  guard2 = false;
  if (CV_EML_COND(0, 1, 8, CV_RELATIONAL_EVAL(4U, 0U, 8, c18_b_V5, rtNaN, -1, 0U,
        c18_b_V5 == rtNaN))) {
    guard2 = true;
  } else if (CV_EML_COND(0, 1, 9, CV_RELATIONAL_EVAL(4U, 0U, 9, c18_b_V5, rtInf,
    -1, 0U, c18_b_V5 == rtInf))) {
    guard2 = true;
  } else {
  ...
  guard1 = false;
  if (CV_EML_COND(0, 1, 10, CV_RELATIONAL_EVAL(4U, 0U, 10, c18_b_V6, rtNaN, -1,
        0U, c18_b_V6 == rtNaN))) {
    guard1 = true;
  } else if (CV_EML_COND(0, 1, 11, CV_RELATIONAL_EVAL(4U, 0U, 11, c18_b_V6,
               rtInf, -1, 0U, c18_b_V6 == rtInf))) {
    guard1 = true;
  } else {
  ...
  c18_b_aX = c18_b_aXM_IMU + c18_d_y * (c18_b_U_dot - c18_b_UM_dot);
  ...
  c18_b_aY = c18_b_aYM_IMU + c18_h_y * (c18_b_V_dot - c18_b_VM_dot);
  ...
  c18_b_r = c18_b_rM_IMU + c18_l_y * (c18_b_r_eom - c18_b_rM_eom);
  _SFD_EML_CALL(0U, chartInstance->c18_sfEvent, -23);
  ...
  *chartInstance->c18_r = c18_b_r;
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_aX, 4U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_aY, 5U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_r, 6U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_V_dot, 7U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_r_eom, 8U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_UM_dot, 9U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_VM_dot, 10U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_rM_eom, 11U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_V1, 12U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_V2, 13U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_V3, 14U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_V4, 15U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_V5, 16U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c18_V6, 17U);
}
  ...
  *c18_inData)
{
  ...
  const mxArray *c18_y = NULL;
  SFc18_SS6_EstimationInstanceStruct *chartInstance;
  chartInstance = (SFc18_SS6_EstimationInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c18_SS6_Estimation_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c18_identifier)
{
  ...
  c18_y = c18_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c18_b_is_active_c18_SS6_Estimation), &c18_thisId);
  sf_mex_destroy(&c18_b_is_active_c18_SS6_Estimation);
  return c18_y;
}
...
static void init_simulink_io_address(SFc18_SS6_EstimationInstanceStruct
  *chartInstance)
{
  chartInstance->c18_aXM_IMU = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c18_aYM_IMU = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c18_rM_IMU = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
  ...
  chartInstance->c18_VM_dot = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 7);
  chartInstance->c18_rM_eom = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 8);
...
void sf_c18_SS6_Estimation_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2099134525U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(21378193U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(494122357U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4180717101U);
}

mxArray* sf_c18_SS6_Estimation_get_post_codegen_info(void);
mxArray *sf_c18_SS6_Estimation_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("U43TkRvySL7LKANR05LMhF");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c18_SS6_Estimation_get_post_codegen_info();
...
mxArray *sf_c18_SS6_Estimation_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c18_SS6_Estimation_jit_fallback_info(void)
{
...
mxArray *sf_c18_SS6_Estimation_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c18_SS6_Estimation(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"aX\",},{M[1],M[15],T\"aY\",},{M[1],M[6],T\"r\",},{M[8],M[0],T\"is_active_c18_SS6_Estimation\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c18_SS6_Estimation_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc18_SS6_EstimationInstanceStruct *)
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"aXM_IMU");
          _SFD_SET_DATA_PROPS(1,1,1,0,"aYM_IMU");
          _SFD_SET_DATA_PROPS(2,1,1,0,"rM_IMU");
          _SFD_SET_DATA_PROPS(3,1,1,0,"U_dot");
          _SFD_SET_DATA_PROPS(4,2,0,1,"aX");
          _SFD_SET_DATA_PROPS(5,2,0,1,"aY");
          _SFD_SET_DATA_PROPS(6,2,0,1,"r");
          _SFD_SET_DATA_PROPS(7,1,1,0,"V_dot");
          _SFD_SET_DATA_PROPS(8,1,1,0,"r_eom");
          _SFD_SET_DATA_PROPS(9,1,1,0,"UM_dot");
          _SFD_SET_DATA_PROPS(10,1,1,0,"VM_dot");
          _SFD_SET_DATA_PROPS(11,1,1,0,"rM_eom");
          _SFD_SET_DATA_PROPS(12,1,1,0,"V1");
          _SFD_SET_DATA_PROPS(13,1,1,0,"V2");
          _SFD_SET_DATA_PROPS(14,1,1,0,"V3");
          _SFD_SET_DATA_PROPS(15,1,1,0,"V4");
          _SFD_SET_DATA_PROPS(16,1,1,0,"V5");
          _SFD_SET_DATA_PROPS(17,1,1,0,"V6");
        ...
        _SFD_CV_INIT_EML(0,1,1,6,0,0,0,0,0,12,6);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,461);
        _SFD_CV_INIT_EML_IF(0,1,0,107,130,-1,147);
        _SFD_CV_INIT_EML_IF(0,1,1,148,171,-1,188);
        _SFD_CV_INIT_EML_IF(0,1,2,189,212,-1,229);
        _SFD_CV_INIT_EML_IF(0,1,3,230,253,-1,270);
        _SFD_CV_INIT_EML_IF(0,1,4,271,294,-1,311);
        _SFD_CV_INIT_EML_IF(0,1,5,312,335,-1,352);

        {
          static int condStart[] = { 111, 121 };

          static int condEnd[] = { 118, 129 };

          static int pfixExpr[] = { 0, 1, -2 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,111,129,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 152, 162 };

          static int condEnd[] = { 159, 170 };

          static int pfixExpr[] = { 0, 1, -2 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,152,170,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 193, 203 };

          static int condEnd[] = { 200, 211 };

          static int pfixExpr[] = { 0, 1, -2 };

          _SFD_CV_INIT_EML_MCDC(0,1,2,193,211,2,4,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 234, 244 };

          static int condEnd[] = { 241, 252 };

          static int pfixExpr[] = { 0, 1, -2 };

          _SFD_CV_INIT_EML_MCDC(0,1,3,234,252,2,6,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 275, 285 };

          static int condEnd[] = { 282, 293 };

          static int pfixExpr[] = { 0, 1, -2 };

          _SFD_CV_INIT_EML_MCDC(0,1,4,275,293,2,8,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 316, 326 };

          static int condEnd[] = { 323, 334 };

          static int pfixExpr[] = { 0, 1, -2 };

          _SFD_CV_INIT_EML_MCDC(0,1,5,316,334,2,10,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,111,118,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,1,121,129,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,2,152,159,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,3,162,170,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,4,193,200,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,5,203,211,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,6,234,241,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,7,244,252,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,8,275,282,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,9,285,293,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,10,316,323,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,11,326,334,-1,0);
        ...
        _SFD_SET_DATA_COMPILED_PROPS(17,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c18_sf_marshallOut,(MexInFcnForType)NULL);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c18_aXM_IMU);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c18_aYM_IMU);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c18_rM_IMU);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c18_U_dot);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c18_aX);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c18_aY);
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c18_r);
        _SFD_SET_DATA_VALUE_PTR(7U, chartInstance->c18_V_dot);
        _SFD_SET_DATA_VALUE_PTR(8U, chartInstance->c18_r_eom);
        _SFD_SET_DATA_VALUE_PTR(9U, chartInstance->c18_UM_dot);
        _SFD_SET_DATA_VALUE_PTR(10U, chartInstance->c18_VM_dot);
        _SFD_SET_DATA_VALUE_PTR(11U, chartInstance->c18_rM_eom);
        _SFD_SET_DATA_VALUE_PTR(12U, chartInstance->c18_V1);
        _SFD_SET_DATA_VALUE_PTR(13U, chartInstance->c18_V2);
        _SFD_SET_DATA_VALUE_PTR(14U, chartInstance->c18_V3);
        _SFD_SET_DATA_VALUE_PTR(15U, chartInstance->c18_V4);
        _SFD_SET_DATA_VALUE_PTR(16U, chartInstance->c18_V5);
        _SFD_SET_DATA_VALUE_PTR(17U, chartInstance->c18_V6);
      }
    } else {
...
{
  return "tK3dTgvy7FyQPZGnhLaa9E";
}

static void sf_opaque_initialize_c18_SS6_Estimation(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc18_SS6_EstimationInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c18_SS6_Estimation((SFc18_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
  initialize_c18_SS6_Estimation((SFc18_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c18_SS6_Estimation(void *chartInstanceVar)
{
  enable_c18_SS6_Estimation((SFc18_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c18_SS6_Estimation(void *chartInstanceVar)
{
  disable_c18_SS6_Estimation((SFc18_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c18_SS6_Estimation(void *chartInstanceVar)
{
  sf_gateway_c18_SS6_Estimation((SFc18_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c18_SS6_Estimation(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c18_SS6_Estimation((SFc18_SS6_EstimationInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c18_SS6_Estimation(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c18_SS6_Estimation((SFc18_SS6_EstimationInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c18_SS6_Estimation(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc18_SS6_EstimationInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c18_SS6_Estimation((SFc18_SS6_EstimationInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc18_SS6_Estimation((SFc18_SS6_EstimationInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c18_SS6_Estimation(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c18_SS6_Estimation(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3414570077U));
  ssSetChecksum1(S,(2688330949U));
  ssSetChecksum2(S,(438011275U));
  ssSetChecksum3(S,(250499996U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c18_SS6_Estimation(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c18_SS6_Estimation(SimStruct *S)
{
  SFc18_SS6_EstimationInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc18_SS6_EstimationInstanceStruct *)utMalloc(sizeof
    (SFc18_SS6_EstimationInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc18_SS6_EstimationInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c18_SS6_Estimation;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c18_SS6_Estimation;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c18_SS6_Estimation;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c18_SS6_Estimation;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c18_SS6_Estimation;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c18_SS6_Estimation;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c18_SS6_Estimation;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c18_SS6_Estimation;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c18_SS6_Estimation;
  chartInstance->chartInfo.mdlStart = mdlStart_c18_SS6_Estimation;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c18_SS6_Estimation;
...
void c18_SS6_Estimation_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c18_SS6_Estimation(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c18_SS6_Estimation(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c18_SS6_Estimation(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c18_SS6_Estimation_method_dispatcher.\n"
