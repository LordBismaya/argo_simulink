  ...
  *chartInstance)
{
  ...
  c7_n_x = c7_l_y;
  c7_o_x = c7_n_x;
  c7_o_x = muDoubleScalarAtan(c7_o_x);
  c7_b_a_mL = -c7_o_x;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4241726048U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3335377422U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2819518905U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(262377525U);
}
...
mxArray *sf_c7_SS_jun_25_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Svc7MEg0A7UVX82TzAeMJF");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1716);
        _SFD_CV_INIT_EML_IF(0,1,0,896,905,927,946);
        _SFD_CV_INIT_EML_IF(0,1,1,1192,1201,1223,1242);
        _SFD_CV_INIT_EML_IF(0,1,2,1490,1499,1521,1540);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,899,904,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,1,1195,1200,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,2,1493,1498,-1,2);
...
static void mdlSetWorkWidths_c7_SS_jun_25(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(914240687U));
  ssSetChecksum1(S,(1347569271U));
  ssSetChecksum2(S,(595776109U));
  ssSetChecksum3(S,(541728931U));
